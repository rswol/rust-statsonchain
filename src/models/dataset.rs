...
pub struct Dataset {
    ...
    pub columns: ::std::collections::HashMap<String, Vec<serde_json::Value>>,
    #[serde(rename = "order")]
...
impl Dataset {
    pub fn new(columns: ::std::collections::HashMap<String, Vec<serde_json::Value>>, order: Vec<String>) -> Dataset {
        Dataset {
            columns,
            order,
            time: None,
